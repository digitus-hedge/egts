    ...
    <form action="{{ route('admin.home.about.store') }}" method="POST" enctype="multipart/form-data" id="aboutForm">
        ...
        <div class="card">
            ...
            <div class="image-slot" style="max-width:300px;">
                <div class="drop img-slot {{ $about->image ? 'filled' : '' }}" data-file-input="file-image"  id="drop-image"   onclick="handleDropClick(this)">
                    @if ($about->image)
...
function showAboutValidationErrors(errors) {
    ...
    const fieldMap = {
        ...
        image: f => document.getElementById('drop-image'),
