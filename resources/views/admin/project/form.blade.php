...
<div class="form-header">
    <h4>
        <i class="bi bi-{{ $project->exists ? 'pencil-square' : 'plus-circle' }}"></i>
...
<form action="{{ $project->exists ? route('admin.home.projects.update', $project->id) : route('admin.home.projects.store') }}"
                ...
                <div class="form-card">
                    ...
                    <div class="image-upload-box">
                        <div class="preview-wrap">
                            @if ($project->image)
                                <img src="{{ Storage::url($project->image) }}" class="preview-img" id="preview-image">
                            @else
