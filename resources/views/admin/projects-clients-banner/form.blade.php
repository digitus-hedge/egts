...
<div class="wrap">
    ...
    <div class="header">
        <div>
            <h1>Projects &amp; Clients — Banner</h1>
            <p>The hero banner and page content shown above the client logo grid.</p>
        </div>
    </div>

    <form action="{{ route('admin.home.projects-clients.banner.store') }}" method="POST" enctype="multipart/form-data" id="projectsClientsForm">
        @csrf
        ...
        <div class="card">
            <div class="section-title">
                <h2><span class="icon"><i class="bi bi-file-text"></i></span> Page Content</h2>
            </div>
        ...
        <div class="savebar">
            <div class="savebar-inner">
                <span class="savebar-status">All changes save to the live Projects &amp; Clients page</span>
                <div class="btn-group">
