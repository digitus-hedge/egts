...
<div class="wrap">
    ...
    <div class="header">
        <div>
            <h1>Service Banner Section</h1>
            <p>The banner shown at the top of your Services page — title, description, image, and SEO meta.</p>
        </div>
    </div>

    <form action="{{ route('admin.service.banner.store') }}" method="POST" enctype="multipart/form-data" id="serviceBannerForm">
        @csrf
        ...
        <div class="card">
            ...
            <div class="field">
                <div class="field-top">
                    ...
                    <span class="field-hint"><span id="metaTitleCount">{{ strlen(old('meta_title', $about->meta_title ?? '')) }}</span> / 60</span>
                </div>
            ...
            <div class="field" style="margin-bottom:0;">
                <div class="field-top">
                    ...
                    <span class="field-hint"><span id="metaDescCount">{{ strlen(old('meta_description', $about->meta_description ?? '')) }}</span> / 160</span>
                </div>
...
function submitServiceBannerForm() {
    ...
    .then(async (response) => {
        ...
        Swal.fire({
            icon: 'success',
            title: 'Saved!',
            text: (data && data.message) ? data.message : 'Service Banner Updated successfully.',
            confirmButtonColor: '#BF0001',
            timer: 2000,
            timerProgressBar: true
        }).then(() => {
...
<script>
document.addEventListener('DOMContentLoaded', function () {
    const fieldOrder = ['title', 'description', 'image', 'meta_title', 'meta_description'];
