...
<div class="wrap">
    <div class="crumbs">
        <span onclick="window.location='{{ route('admin.home.facility.tools') }}'">Tools</span>
        <span>&rsaquo;</span>
        <b>{{ $tool->exists ? 'Edit' : 'Add New' }}</b>
    </div>

    <div class="header">
        <div>
            <h1>{{ $tool->exists ? 'Edit Tool' : 'Add Tool' }}</h1>
            <p>A tool shown on your Facility &amp; Capabilities page.</p>
        </div>
        <a href="{{ route('admin.home.facility.tools') }}" class="btn-back">
            <i class="bi bi-arrow-left"></i> Back to list
        </a>
    </div>

    <form action="{{ $tool->exists ? route('admin.home.facility.tools.update', $tool->id) : route('admin.home.facility.tools.store') }}"
        ...
        <div class="card">
            ...
            <div class="field" style="margin-bottom:0;">
                <input type="text" name="title" value="{{ old('title', $tool->title) }}"
        ...
        <div class="card">
            ...
            <div class="field" style="margin-bottom:0;">
                <textarea name="description" rows="4"
                          ...
                          placeholder="Enter tool description">{{ old('description', $tool->description) }}</textarea>
                @error('description')
                    <span class="field-error"><i class="bi bi-exclamation-circle"></i> {{ $message }}</span>
                @enderror
            </div>
        ...
        <div class="card">
            ...
            <div class="notice caution">
                ...
                <p>Recommended size: 182 × 160px · JPG, PNG, WEBP · up to 10MB</p>
            </div>
        ...
        <div class="savebar">
            <div class="savebar-inner">
                ...
                <div class="btn-group">
                    <a href="{{ route('admin.home.facility.tools') }}" class="btn-cancel">Cancel</a>
                    <button type="submit" class="btn-save">
                        <i class="bi bi-check-lg"></i>
                        {{ $tool->exists ? 'Update' : 'Save' }}
                    </button>
                </div>
            </div>
        </div>
