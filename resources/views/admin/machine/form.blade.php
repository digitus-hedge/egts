...
<div class="form-header">
    <h4>
        <i class="bi bi-{{ $machine->exists ? 'pencil-square' : 'plus-circle' }}"></i>
        {{ $machine->exists ? 'Edit Machine' : 'Add Machine' }}
    </h4>
                ...
                <div class="form-card">
                    ...
                    <div class="image-upload-box">
                        <div class="preview-wrap">
                            @if ($machine->image)
                                <img src="{{ Storage::url($machine->image) }}" class="preview-img" id="preview-image">
                            @else
