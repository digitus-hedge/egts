...
<div class="form-header">
    <h4>
        <i class="bi bi-{{ $masterProject->exists ? 'pencil-square' : 'plus-circle' }}"></i>
        {{ $masterProject->exists ? 'Edit Project' : 'Add Project' }}
    </h4>
                    ...
                    <div class="image-upload-box">
                        <div class="preview-wrap">
                            @if ($masterProject->image)
                                <img src="{{ Storage::url($masterProject->image) }}" class="preview-img" id="preview-image">
                            @else
