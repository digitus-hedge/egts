...
<div class="wrap">
    <div class="crumbs">
        <span onclick="window.location='{{ route('admin.home.certificates') }}'">Certificates</span>
        <span>&rsaquo;</span>
        <b>{{ $certificate->exists ? 'Edit' : 'Add New' }}</b>
    </div>

    <div class="header">
        <div>
            <h1>{{ $certificate->exists ? 'Edit Certificate' : 'Add Certificate' }}</h1>
            <p>A certification or accreditation shown on your site.</p>
        </div>
    ...
    <form action="{{ $certificate->exists ? route('admin.home.certificates.update', $certificate->id) : route('admin.home.certificates.store') }}"
        ...
        <div class="savebar">
            <div class="savebar-inner">
                <span class="savebar-status">All changes save to the live Certificates page</span>
                <div class="btn-group">
