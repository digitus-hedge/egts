...
<form action="{{ $service->exists ? route('admin.home.services.update', $service->id) : route('admin.home.services.store') }}"
    ...
    <div class="container-fluid px-0">
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-card">
                    <div class="form-group">
                        ...
                        <p class="hint-text">Shown on the homepage card under the title. Keep it brief.</p>
                ...
                <div class="form-card">
                    ...
                    <div class="image-upload-box">
                        ...
                        <label class="upload-btn {{ $errors->has('image') ? 'upload-btn-error' : '' }}">
                            ...
                            <input type="file" name="image" accept="image/*" data-max-size="2"
            ...
            <!-- <div class="col-md-12">
                <div class="form-card">
                    <label class="section-label"><i class="bi bi-file-earmark-richtext"></i> Full Content</label>
                    <p class="hint-text">Shown on the service's detail page (optional).</p>

                    <div id="editor-container">{!! old('content', $service->content) !!}</div>
                    <input type="hidden" name="content" id="content-input" value="{{ old('content', $service->content) }}">
