...
@section('title', 'Contact Us Banner')
@section('content')
...
<form action="{{ route('admin.home.contact-banner.store') }}" method="POST" enctype="multipart/form-data" class="banner-form">
    @csrf
                ...
                <div class="form-card">
                    <div class="form-group">
                        ...
                        <textarea name="description" rows="4"
                                  ...
                                  placeholder="e.g. Reach out to our technical team for machining, threading, repair, and inspection inquiries.">{{ old('description', $contactBanner->description) }}</textarea>
                        @error('description')
                            <span class="field-error"><i class="bi bi-exclamation-circle"></i> {{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="image-upload-box">
                        <div class="preview-wrap">
                            @if ($contactBanner->image)
                                <img src="{{ Storage::url($contactBanner->image) }}" class="preview-img" id="preview-image">
                            @else
...
<style>
    ...
    .image-upload-box { display: flex; flex-direction: column; align-items: flex-start; width: 100%; max-width: 400px; }
