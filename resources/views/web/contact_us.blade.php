...
<body>
    ...
    <main>
        ...
        {{-- ===== Page Hero Section ===== --}}
        <section class="ct-hero" @if(!$contactBanner?->video && $contactBanner?->image) style="background-image:
            url('{{ asset('storage/' . $contactBanner->image) }}');" @endif>

            @if ($contactBanner?->video)
            <video class="ct-hero-video-bg" autoplay muted loop playsinline>
                <source src="{{ asset('storage/' . $contactBanner->video) }}" type="video/mp4">
            </video>
            @endif
        ...
        <section class="ct-heading-section">
            <div class="ct-heading-inner">
                ...
                <p>Whether you need a quote, technical consultation, or want to discuss a project, our team is ready to
                    help. Reach out using the details below or send us a message directly.</p>
            </div>
        </section>
            ...
            <div class="ct-content-inner">
                ...
                <div class="ct-form-col">
                    <div class="ct-form-card">
                        ...
                        <form class="ct-form" action="{{ url('/contact/submit') }}" method="POST" id="contactForm"
                            novalidate>
                            @csrf
                            <div class="ct-form-row">
                                <div class="ct-form-group">
                                    ...
                                    @error('full_name')
                                    <span class="field-error"><i class="bi bi-exclamation-circle"></i>
                                        {{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="ct-form-group">
                            ...
                            <div class="ct-form-group ct-form-group-full">
                                ...
                                <textarea id="message" name="message" rows="5"
                                    ...
                                    placeholder="Tell us about your requirement..." required
    ...
    <script>
        ...
        document.getElementById('contactForm') ? .addEventListener('submit', function (e) {
            ...
            requiredFields.forEach(field => {
                ...
                if (!field.value.trim() || (field.minLength && field.value.trim().length < field
                        .minLength)) {
