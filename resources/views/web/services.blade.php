    ...
    <div class="capabilities-inner">
        ...
        <div class="capabilities-header">
            ...
            <div class="capabilities-header-right">
                <p>Focused technical services covering equipment inspection, NDT, quality control, repair support and specialist inspection facilities.</p>
            </div>
        </div>
        ...
        <div class="capabilities-grid">
            ...
            <div class="capability-card">
                <img src="{{ asset('images/service-1.webp') }}" alt="Inspection Expertise That Keeps Operations Moving">
                <div class="capability-body">
                    <h3>Inspection Expertise That Keeps Operations Moving</h3>
                    <p>Inspection of drill pipes, collars, tool joints, connections and related components.</p>
                    <a href="{{ url('/services') }}" class="capability-link">
                        View Services
            ...
            <div class="capability-card">
                    <img src="{{ asset('images/service-2.webp') }}" alt="Rig Inspection">
                <div class="capability-body">
                    <h3>Rig Inspection</h3>
                    <p>Technical examination of drilling rigs and critical mechanical and structural equipment.</p>
                    <a href="{{ url('/services') }}" class="capability-link">
                        View Services
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M5 12h14M13 6l6 6-6 6"/></svg>
                    </a>
            ...
            <div class="capability-card">
                <img src="{{ asset('images/service-3.webp') }}" alt="Non-Destructive Testing">
                <div class="capability-body">
                    <h3>Non-Destructive Testing</h3>
                    <p>NDT methods for identifying surface and subsurface discontinuities without damaging components.</p>
                    <a href="{{ url('/services') }}" class="capability-link">
                        View Services
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M5 12h14M13 6l6 6-6 6"/></svg>
                    </a>
            ...
            <div class="capability-card">
                <img src="{{ asset('images/service-4.webp') }}" alt="Quality Control & Calibration">
                <div class="capability-body">
                    <h3>Quality Control & Calibration</h3>
                    <p>Calibrated measuring equipment and API thread gauges ensuring consistent accuracy.</p>
                    <a href="{{ url('/services') }}" class="capability-link">
                        View Services
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M5 12h14M13 6l6 6-6 6"/></svg>
                    </a>
            ...
            <div class="capability-card">
                <img src="{{ asset('images/service-5.webp') }}" alt="Repair & Remanufacturing">
                <div class="capability-body">
                    <h3>Repair & Remanufacturing</h3>
                    <p>Restoring critical oilfield equipment to original specification and performance.</p>
                    <a href="{{ url('/services') }}" class="capability-link">
                        View Services
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M5 12h14M13 6l6 6-6 6"/></svg>
                    </a>
            ...
            <div class="capability-card">
                <img src="{{ asset('images/service-6.webp') }}" alt="Technical Support Services">
                <div class="capability-body">
                    <h3>Technical Support Services</h3>
                    <p>On-site technical assistance and consultation for demanding field operations.</p>
                    <a href="{{ url('/services') }}" class="capability-link">
                        View Services
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M5 12h14M13 6l6 6-6 6"/></svg>
                    </a>
...
<section class="services-cta-section">
    <div class="services-cta-inner">
        ...
        <div class="services-cta-content">
            ...
            <p>Talk to EGTS about your equipment, inspection requirements and technical challenges. Our team can help identify the right inspection approach for your operation.</p>
