...
<body>
    ...
    <main>
        ...
        <section class="au-hero" @if(!$whyChooseUs?->banner_video && $whyChooseUs?->banner_image)
            style="background-image: url('{{ asset('storage/' . $whyChooseUs->banner_image) }}');" @endif>

            @if ($whyChooseUs?->banner_video)
            <video class="au-hero-video-bg" autoplay muted loop playsinline>
                <source src="{{ asset('storage/' . $whyChooseUs->banner_video) }}" type="video/mp4">
            </video>
            @endif
        ...
        <section class="au-built-section">
            ...
            <div class="au-built-inner">
                <div class="au-built-images">
                    <img src="{{ asset('storage/' . $whyChooseUs->section_two_image_one) }}" alt="Offshore Platform"
                        class="au-img-primary">
                    <img src="{{ asset('storage/' . $whyChooseUs->section_two_image_two) }}" alt="Field Technician"
                        class="au-img-secondary">
                </div>
            ...
            <div class="au-mv-inner">
                ...
                <div class="au-mv-row">
                    ...
                    <div class="au-mv-image">
                        <img src="{{ asset('storage/' . $whyChooseUs->mission_image) }}"
                            alt="Mission - EGTS Technician">
                    </div>
                </div>
                ...
                <div class="au-mv-row au-mv-row-reverse">
                    ...
                    <div class="au-mv-image">
                        <img src="{{ asset('storage/' . $whyChooseUs->vision_image) }}"
                            alt="Vision - Oilfield Facility">
                    </div>
                </div>
        ...
        <section class="au-foundation-section">
            ...
            <div class="au-foundation-inner">
                ...
                <div class="au-foundation-grid">
                    ...
                    <div class="au-foundation-card"
                        style="background-image: url('{{ asset('storage/' . $whyChooseUs->values_image) }}');">
                    ...
                    <div class="au-foundation-card"
                        style="background-image: url('{{ asset('storage/' . $whyChooseUs->commitment_image) }}');">
                        <div class="au-foundation-overlay"></div>
                        <div class="au-foundation-content">
        ...
        <section class="au-infra-section">
            <div class="au-infra-inner">
                ...
                <p class="au-infra-sub">Our facility combines modern machinery and inspection equipment to support
                    demanding oilfield applications</p>
        ...
        <section class="au-closing-section">
            ...
            <div class="au-closing-inner">
                ...
                <div class="au-closing-content">
                    ...
                    <p>Partner with EGTS for precision machining, premium threading, repair, remanufacturing, and
                        technical inspection services. With advanced capabilities, experienced professionals, and a
                        strong commitment to quality and safety, we deliver reliable, efficient, and industry-focused
                        solutions designed to meet demanding standards and keep your operations performing at their
                        best.</p>
